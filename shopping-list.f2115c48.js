function t(t,e,n,a){Object.defineProperty(t,e,{get:n,set:a,enumerable:!0,configurable:!0})}function e(t){return t&&t.__esModule?t.default:t}var n="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},o={},i=n.parcelRequired7c6;null==i&&((i=function(t){if(t in a)return a[t].exports;if(t in o){var e=o[t];delete o[t];var n={id:t,exports:{}};return a[t]=n,e.call(n.exports,n,n.exports),n.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){o[t]=e},n.parcelRequired7c6=i),i.register("kyEFX",function(e,n){t(e.exports,"register",function(){return a},function(t){return a=t}),t(e.exports,"resolve",function(){return o},function(t){return o=t});var a,o,i={};a=function(t){for(var e=Object.keys(t),n=0;n<e.length;n++)i[e[n]]=t[e[n]]},o=function(t){var e=i[t];if(null==e)throw Error("Could not resolve bundle with id "+t);return e}}),i("kyEFX").register(JSON.parse('{"f9bx4":"shopping-list.f2115c48.js","8OQ7p":"icons.788c0c72.svg","hhQ3F":"shopping-list.3cc7180e.js","4VTmX":"shopping-list.b4d67014.js"}')),i("cqUhq"),i("1GFL3"),i("7ECWb");var s={};s=new URL(i("kyEFX").resolve("8OQ7p"),import.meta.url).toString();const r={list:document.querySelector(".shopping-list-list"),emptyPage:document.querySelector(".empty-sh-page"),SHOPPING_LIST_LS:"shopping list"};function l(t=[]){if(r.list.innerHTML="",t.length){let n=t.map(t=>({_id:t.book.id,book_image:t.book.img,title:t.book.title,list_name:t.book.bookName,description:t.book.description,author:t.book.author,buy_links:t.book.shops}));r.list.insertAdjacentHTML("beforeend",(r.emptyPage.classList.add("visually-hidden"),n.map(({_id:t,book_image:n,title:a,list_name:o,description:i,author:r,buy_links:l})=>{let c=`<svg class="book-logo">
        <use href="${e(s)}#book"></use>
                ...
                <p class="shopping-book-author">${r}</p>
                  <ul class="links-to-buy">
                    <li class="item-to-buy">
                      <a href="${u}" target="_blank" rel="noreferrer noopener nofollow">
          ...
          </li>`}).join("")))}else r.emptyPage.classList.contains("visually-hidden")&&r.emptyPage.classList.remove("visually-hidden")}r.list.addEventListener("click",function(t){let e=t.target.closest(".trash-btn");if(e)try{let t=JSON.parse(localStorage.getItem(r.SHOPPING_LIST_LS));localStorage.removeItem(r.SHOPPING_LIST_LS);let n=t.filter(t=>t.id!==e.id);if(localStorage.setItem(r.SHOPPING_LIST_LS,JSON.stringify(n)),!n.length){l(n);return}b(n,1,!1,!0)}catch(t){console.log("ERROR!",t)}});let c=[],u=0;const g={a:!0,b:!0},p={paginationContainer:document.querySelector(".pagination-container")};p.paginationContainer.addEventListener("click",function(t){t.preventDefault();let e=t.target.closest(".js-pagination-pages"),n=t.target.closest(".js-pagination-button");if(e){let t=e.dataset.pagination;"..."===t?console.log('case "..."'):function(t){let e=v();k(e),m(Number(t)),l(y(Number(t)))}(t)}if(n){let t=n.dataset.pagination;switch(t){case"start":!function(){b(c,1);let t=v();k(t),m(1),l(y(1))}();break;case"backward":!function(){let t=v();if(1===t)return;let e=Number(document.querySelector(".js-pagination-pages").dataset.pagination);t<=3?(k(t),b(c,1)):(k(t),b(c,e-1)),m(t-1),l(y(t-1))}();break;case"forward":!function(){let t=v();if(t===d.length)return;let e=Number(document.querySelector(".js-pagination-pages").dataset.pagination);k(t),b(c,e+1),m(t+1),l(y(t+1))}();break;case"end":!function(){b(c,d.length);let t=v();k(t),m(d.length),l(y(d.length))}();break;default:return}}});let d=[],h=0;function f(t){d=[];for(let e=0;e<Math.ceil(t.length/u);e+=1)d.push(e+1)}function b(t,n=1,a=!1,o=!1){if("undefined"===t||0===t.length)return;if(a&&(c=[...t],S(window.innerWidth),f(c),l(y(1))),o){!function(t){f(c=[...t]);let e=1;if(d.length>1&&(e=v()),c.length<=u){p.paginationContainer.innerHTML="",l(y(1));return}if(e>d.length){b(c,d.length),m(d.length),l(y(d.length));return}if(e<d.length&&1===e){b(c,1),m(1),l(y(1));return}if(y(e).length<=u){let t=Number(document.querySelector(".js-pagination-pages").dataset.pagination);b(c,t),m(e),l(y(e))}}(t);return}if(t.length<=u)return;let i=!0;n+h-1>=d.length&&(i=!1),p.paginationContainer.innerHTML=function(t,n,a=!0){return`<div class="left-arrows-wrapper">
