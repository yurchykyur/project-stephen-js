function t(t,e,n,a){Object.defineProperty(t,e,{get:n,set:a,enumerable:!0,configurable:!0})}function e(t){return t&&t.__esModule?t.default:t}var n="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},i={},o=n.parcelRequired7c6;null==o&&((o=function(t){if(t in a)return a[t].exports;if(t in i){var e=i[t];delete i[t];var n={id:t,exports:{}};return a[t]=n,e.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){i[t]=e},n.parcelRequired7c6=o),o.register("kyEFX",function(e,n){t(e.exports,"register",function(){return a},function(t){return a=t}),t(e.exports,"resolve",function(){return i},function(t){return i=t});var a,i,o={};a=function(t){for(var e=Object.keys(t),n=0;n<e.length;n++)o[e[n]]=t[e[n]]},i=function(t){var e=o[t];if(null==e)throw Error("Could not resolve bundle with id "+t);return e}}),o("kyEFX").register(JSON.parse('{"f9bx4":"shopping-list.494e3c9d.js","8OQ7p":"icons.788c0c72.svg","9sSkM":"index.69f00d55.js","g8iDC":"index.889a0bd7.js"}')),o("3ezVE"),o("8IXMh"),o("X4ZWf"),o("3Xhi6"),o("7Th1V"),o("HlhYT");var s={};s=new URL(o("kyEFX").resolve("8OQ7p"),import.meta.url).toString();const r={list:document.querySelector(".shopping-list-list"),emptyPage:document.querySelector(".empty-sh-page"),SHOPPING_LIST_LS:"shopping list"};function l(t=[]){if(r.list.innerHTML="",t.length){let n=t.map(t=>({_id:t.book.id,book_image:t.book.img,title:t.book.title,list_name:t.book.bookName,description:t.book.description,author:t.book.author,buy_links:t.book.shops}));r.list.insertAdjacentHTML("beforeend",(r.emptyPage.classList.add("visually-hidden"),n.map(({_id:t,book_image:n,title:a,list_name:i,description:o,author:r,buy_links:l})=>{let u=`<svg class="book-logo">
        <use href="${e(s)}#book"></use>
          ...
          </li>`}).join("")))}else r.emptyPage.classList.contains("visually-hidden")&&r.emptyPage.classList.remove("visually-hidden")}r.list.addEventListener("click",function(t){let e=t.target.closest(".trash-btn");if(e)try{let t=JSON.parse(localStorage.getItem(r.SHOPPING_LIST_LS));localStorage.removeItem(r.SHOPPING_LIST_LS);let n=t.filter(t=>t.id!==e.id);if(localStorage.setItem(r.SHOPPING_LIST_LS,JSON.stringify(n)),!n.length){h(n,1,!1,!0);return}h(n,1,!1,!0)}catch(t){console.log("ERROR!",t)}});let u=[],c=0,p=0;const g={a:!0,b:!0},d={paginationContainer:document.querySelector(".pagination-container")};d.paginationContainer.addEventListener("click",function(t){t.preventDefault();let e=t.target.closest(".js-pagination-pages"),n=t.target.closest(".js-pagination-button");if(e){let t=e.dataset.pagination;"..."===t?console.log('case "..."'):function(t){let e=v();k(e),m(Number(t)),l(w(Number(t)))}(t)}if(n){let t=n.dataset.pagination;switch(t){case"start":!function(){h(u,1);let t=v();k(t),m(1),l(w(1))}();break;case"backward":!function(){let t=v();if(1===t)return;let e=Number(document.querySelector(".js-pagination-pages").dataset.pagination);t<=3?(k(t),h(u,1)):(k(t),h(u,e-1)),m(t-1),l(w(t-1))}();break;case"forward":!function(){let t=v();if(t===p)return;let e=Number(document.querySelector(".js-pagination-pages").dataset.pagination);k(t),h(u,e+1),m(t+1),l(w(t+1))}();break;case"end":!function(){h(u,p);let t=v();k(t),m(p),l(w(p))}();break;default:return}}});let f=0;function b(t){p=Math.ceil(t.length/c)}function h(t,n=1,a=!1,i=!1){if("undefined"===t||0===t.length){u=[],l();return}if(a&&(u=[...t],S(window.innerWidth),b(u),l(w(1))),i){!function(t){b(u=[...t]);let e=1;if(p>1&&(e=v()),u.length<=c){d.paginationContainer.innerHTML="",l(w(1));return}if(e>p){h(u,p),m(p),l(w(p));return}if(e<p&&1===e){h(u,1),m(1),l(w(1));return}if(w(e).length<=c){let t=Number(document.querySelector(".js-pagination-pages").dataset.pagination);h(u,t),m(e),l(w(e))}}(t);return}if(t.length<=c)return;let o=!0;n+f-1>=p&&(o=!1),d.paginationContainer.innerHTML=function(t,n,a=!0){return`<div class="left-arrows-wrapper">
